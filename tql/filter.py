...
FILTERS = {
    ...
    'ltrim': (lambda s: s.lstrip(), 1, "<col>|ltrim", "str", "str", "Strip whitespace characters from the left end of the string."),
    'rstrip': (lambda s, c: s.rstrip(c), 1, "<col>|rstrip:<chars>", "str", "str", "Strip <chars> from the right end of the string."),
    'rtrim': (lambda s: s.rstrip(), 1, "<col>|rtrim", "str", "str", "Strip whitespace characters from the right end of the string."),
